...
import { userRegisterService ,userCodeService } from '../../../services/type/index'
...
const sendEmail = async() => {
  console.log(registerInfo.value.email);
  const res = await userCodeService(registerInfo.value.email)
  console.log(res);
